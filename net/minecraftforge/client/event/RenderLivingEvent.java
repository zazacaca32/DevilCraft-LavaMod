...
public abstract class RenderLivingEvent extends Event
{
    ...
    {
        public Specials(EntityLiving entity, RenderLiving renderer)
        {
        ...
        {
            public Pre(EntityLiving entity, RenderLiving renderer)
            {
                super(entity, renderer);
            }
        }
        ...
        {
            public Post(EntityLiving entity, RenderLiving renderer)
            {
                super(entity, renderer);
            }
        }
