...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float par1)
    {
        ...
        if (itemstack != null)
        {
            ...
            f6 = (float)(i >> 16 & 255) / 255.0F;
            f7 = (float)(i >> 8 & 255) / 255.0F;
            f5 = (float)(i & 255) / 255.0F;
            GL11.glColor4f(f3 * f6, f3 * f7, f3 * f5, 1.0F);
        }
        else
        {
        ...
        if (itemstack != null && itemstack.getItem() instanceof ItemMap)
        {
            ...
            f5 = MathHelper.sin(MathHelper.sqrt_float(f6) * (float)Math.PI);
            GL11.glTranslatef(-f5 * 0.4F, MathHelper.sin(MathHelper.sqrt_float(f6) * (float)Math.PI * 2.0F) * 0.2F, -f7 * 0.2F);
            f6 = 1.0F - f2 / 45.0F + 0.1F;
            ...
            f6 = -MathHelper.cos(f6 * (float)Math.PI) * 0.5F + 0.5F;
            GL11.glTranslatef(0.0F, 0.0F * f4 - (1.0F - f1) * 1.2F - f6 * 0.5F + 0.04F, -0.9F * f4);
            GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
            GL11.glRotatef(f6 * -85.0F, 0.0F, 0.0F, 1.0F);
            GL11.glEnable(GL12.GL_RESCALE_NORMAL);
            ...
            f5 = MathHelper.sin(f7 * f7 * (float)Math.PI);
        ...
        else if (itemstack != null)
        {
            ...
            if (entityclientplayermp.getItemInUseCount() > 0)
            {
                ...
                {
                    f7 = (float)entityclientplayermp.getItemInUseCount() - par1 + 1.0F;
                    f5 = 1.0F - f7 / (float)itemstack.getMaxItemUseDuration();
                    f8 = 1.0F - f5;
                    f8 = f8 * f8 * f8;
                    f8 = f8 * f8 * f8;
                    f8 = f8 * f8 * f8;
                    f9 = 1.0F - f8;
                    GL11.glTranslatef(0.0F, MathHelper.abs(MathHelper.cos(f7 / 4.0F * (float)Math.PI) * 0.1F) * (float)((double)f5 > 0.2D ? 1 : 0), 0.0F);
        ...
        else if (!entityclientplayermp.isInvisible())
        {
            ...
            f7 = MathHelper.sin(f6 * (float)Math.PI);
            f5 = MathHelper.sin(MathHelper.sqrt_float(f6) * (float)Math.PI);
            GL11.glTranslatef(-f5 * 0.3F, MathHelper.sin(MathHelper.sqrt_float(f6) * (float)Math.PI * 2.0F) * 0.4F, -f7 * 0.4F);
