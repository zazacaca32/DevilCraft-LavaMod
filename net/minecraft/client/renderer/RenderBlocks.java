    ...
    public boolean renderBlockFluids(Block par1Block, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            if (this.renderAllFaces || flag)
            {
                ...
                {
                    f7 = MathHelper.sin(f9) * 0.25F;
                    f8 = MathHelper.cos(f9) * 0.25F;
            ...
            for (int j1 = 0; j1 < 4; ++j1)
            {
                ...
                if (this.renderAllFaces || aboolean[j1])
                {
                    ...
                    float f12 = icon1.getInterpolatedV((1.0D - d16) * 16.0D * 0.5D);
                    ...
                    tessellator.addVertexWithUV(d17, (double)par3 + d15, d18, (double)f11, (double)f8);
                    tessellator.addVertexWithUV(d19, (double)par3 + d16, d20, (double)f7, (double)f12);
                    tessellator.addVertexWithUV(d19, (double)(par3 + 0), d20, (double)f7, (double)f13);
                    tessellator.addVertexWithUV(d17, (double)(par3 + 0), d18, (double)f11, (double)f13);
                }
            }
