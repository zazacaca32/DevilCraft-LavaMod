...
public class EntityMobGoblin extends LavaEntityMob
{
    ...
    public EntityMobGoblin(World par1World)
    {
        super(par1World);
        super.texture = "/mods/lavamobs/textures/goblin.png";
    ...
    protected void onDeathUpdate()
    {
        ...
        {
            this.entityDropItem(new ItemStack(LavaModMobs.TotemItem.itemID, 2, 0), 1.0F);
        }
