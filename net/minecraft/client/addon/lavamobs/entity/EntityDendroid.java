...
public class EntityDendroid extends LavaEntityMob
{
    ...
    public EntityDendroid(World par1World)
    {
        super(par1World);
        super.texture = "/mods/lavamobs/textures/dendroid.png";
    ...
    protected void onDeathUpdate()
    {
        ...
        {
            this.entityDropItem(new ItemStack(LavaModMobs.TotemItem.itemID, 1, 2), 1.0F);
        }
