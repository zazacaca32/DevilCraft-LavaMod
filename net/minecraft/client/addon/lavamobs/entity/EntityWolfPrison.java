...
public class EntityWolfPrison extends LavaEntityMob
{
    ...
    public EntityWolfPrison(World par1World)
    {
        super(par1World);
        super.texture = "/mods/lavamobs/textures/wolf.png";
    ...
    protected void onDeathUpdate()
    {
        ...
        {
            this.entityDropItem(new ItemStack(LavaModMobs.TotemItem.itemID, 1, 0), 1.0F);
        }
