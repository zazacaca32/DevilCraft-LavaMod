...
public class EntitySpiderPrison extends LavaEntityMob
{
    ...
    public EntitySpiderPrison(World par1World)
    {
        super(par1World);
        super.texture = "/mods/lavamobs/textures/spider.png";
    ...
    protected void onDeathUpdate()
    {
        ...
        {
            this.entityDropItem(new ItemStack(LavaModMobs.TotemItem.itemID, 3, 0), 1.0F);
        }
