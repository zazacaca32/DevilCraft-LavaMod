...
public class EntityFlySkeleton extends LavaEntityMob
{
    ...
    public EntityFlySkeleton(World par1World)
    {
        super(par1World);
        super.texture = "/mods/lavamobs/textures/flyskeleton.png";
    ...
    protected void onDeathUpdate()
    {
        ...
        {
            this.entityDropItem(new ItemStack(LavaModMobs.TotemItem.itemID, 3, 1), 1.0F);
        }
