...
public class EntityGorilla extends LavaEntityMob
{
    ...
    {
        super(par1World);
        super.texture = "/mods/lavamobs/textures/gorilla.png";
    ...
    protected void onDeathUpdate()
    {
        ...
        {
            this.entityDropItem(new ItemStack(LavaModMobs.TotemItem.itemID, 1, 1), 1.0F);
        }
