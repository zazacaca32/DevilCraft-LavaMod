...
public class ShurikenShotItem extends Item
{
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4)
    {
        ...
        par2List.add("§dпри удержании бонус +400.");
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (!event.isCanceled())
        {
            ...
            if ((double)f >= 0.1D)
            {
                ...
                par2World.playSoundAtEntity(par3EntityPlayer, "lavamobs.shuriken", 1.0F, 1.0F / (Item.itemRand.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        if (par2World.isRemote)
        {
            ...
            {
                par2World.playSoundAtEntity(par3EntityPlayer, "lavamobs.spower", 1.0F, 1.5F);
