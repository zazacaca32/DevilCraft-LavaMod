...
public class DemonSpearEntity extends EntityArrow
{
    private int tick = 0;

    public DemonSpearEntity(World par1World)
    {
        super(par1World);
    ...
    public DemonSpearEntity(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        super.renderDistanceWeight = 10.0D;
