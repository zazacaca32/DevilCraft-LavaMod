...
public class LavaUltimaBowRender implements IItemRenderer
{
    public static LavaUltimaBowModel model = new LavaUltimaBowModel();
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        if (data.length > 1 && data[1] instanceof EntityPlayer)
        {
            ...
            else if (toch1 < 30 && toch1 >= 10)
            {
                flag = 2;
            }
            else if (toch1 < 80 && toch1 >= 30)
            {
                flag = 3;
            }
            else if (toch1 >= 80)
        ...
        {
            toch1 = item.stackTagCompound.getInteger("sup");
        }
        ...
        if (type.equals(ItemRenderType.EQUIPPED_FIRST_PERSON))
        {
            ...
            Minecraft.getMinecraft().renderEngine.bindTexture("/mods/lavamobs/textures/bow/UltimaBow.png");
            model.render(flag);
