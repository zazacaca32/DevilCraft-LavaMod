...
public class UltimaSpearEntity extends EntityArrow
{
    private int tick = 0;

    public UltimaSpearEntity(World par1World)
    {
        super(par1World);
    ...
    public UltimaSpearEntity(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        super.renderDistanceWeight = 10.0D;
