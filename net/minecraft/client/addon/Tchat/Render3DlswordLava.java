...
public class Render3DlswordLava implements IItemRenderer
{
    protected Model3DlswordLava model3DlswordLava = new Model3DlswordLava();
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        switch (type.ordinal())
        {
            case 1:
                ...
                Minecraft.getMinecraft().renderEngine.bindTexture("/mods/lsword/textures/items/render/swordLava.png");
                this.model3DlswordLava.render((Entity)data[1], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
                GL11.glPopMatrix();
