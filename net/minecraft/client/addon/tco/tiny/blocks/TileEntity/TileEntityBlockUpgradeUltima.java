...
public class TileEntityBlockUpgradeUltima extends TileEntityBlockBase {
   ...
   public TileEntityBlockUpgradeUltima() {
   ...
   public boolean incSpear(int inc, ItemStack par1ItemStack) {
      ...
      if(par1ItemStack.stackTagCompound == null) {
         return false;
      } else if(par1ItemStack.stackTagCompound.hasKey("swo")) {
         int swo = par1ItemStack.stackTagCompound.getInteger("swo");
         swo += inc;
         par1ItemStack.stackTagCompound.setInteger("swo", swo);
         return true;
      } else {
         par1ItemStack.stackTagCompound.setInteger("swo", inc);
         return true;
      }
   }
         ...
         try {
            if(super.ItemStacks[0] != null && super.ItemStacks[1] != null) {
               ...
               if(!this.isWorking) {
                  ...
                  if(this.getSpear(super.ItemStacks[1]) > 0) {
            ...
            if(this.tickPowerTime >= this.speedreamaningTime && super.ItemStacks[0] != null && super.ItemStacks[1] != null) {
               ...
               if(this.getSpear(super.ItemStacks[1]) != 0 && this.getSpear(super.ItemStacks[1]) > 0) {
                  var51 = false;
               }
