...
public class TileEntityBlockGeneratorLava extends TileEntityBlockBase implements IDarkNode {

   public boolean isWorking = false;
   public short countDarkEnergy;
   public short maxDarkEnergy = 20000;
   public short DarkEnergyController = 0;
   int tick = 0;
   boolean isInit = false;


   public TileEntityBlockGeneratorLava() {
   ...
   String getInventoryName() {
      return "container.GeneratorLavaFab";
   }
