...
public class GuiPressHammer extends GuiContainer {

   float res = 0.0F;
   private TileEntityBlockPressHammer tile;
   private InventoryPlayer inventoryplayer;


   public GuiPressHammer(InventoryPlayer inventoryplayer, TileEntityBlockPressHammer tileentityInputFurnace) {
      super(new ContainerPressHammer(inventoryplayer, tileentityInputFurnace));
      this.tile = tileentityInputFurnace;
      this.inventoryplayer = inventoryplayer;
   }

   protected void drawGuiContainerForegroundLayer(int par1, int par2) {
      super.fontRenderer.drawString("Шанс спрессовки молотов " + this.tile.chance + "%", 7, 10, 4210752);
   }

   protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
      GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
      super.mc.renderEngine.bindTexture("/mods/tco/gui/presshammer.png");
