...
public class GuiTraderOpenCoin extends LAGui {

   private TileEntityBlockTraderCoin tileentity;


   public GuiTraderOpenCoin(InventoryPlayer inventoryplayer, TileEntityBlockTraderCoin tileentity) {
      super(new ContainerTraderOpenCoin(inventoryplayer, tileentity));
   ...
   protected void drawGuiBackgroundLayer(float var1, int var2, int var3) {
      ...
      if(this.tileentity.ControllerTriggerUpdateClient) {
         super.mc.renderEngine.bindTexture("/mods/tco/gui/GUITradeOMatOpenCoin.png");
