...
public class GuiColorer extends GuiContainer {

   float res = 0.0F;
   private TileEntityBlockColorer tile;


   public GuiColorer(InventoryPlayer inventoryplayer, TileEntityBlockColorer tileentityInputFurnace) {
      super(new ContainerColorer(inventoryplayer, tileentityInputFurnace));
   ...
   protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
      ...
      super.mc.renderEngine.bindTexture("/mods/provider/ual/colorergui.png");
