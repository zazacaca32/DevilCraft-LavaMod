...
public class GuiInfo extends GuiContainer {
   ...
   float res = 0.0F;
   private TileEntityBlockInfo tile;
   private InventoryPlayer inventoryplayer;


   public GuiInfo(InventoryPlayer inventoryplayer, TileEntityBlockInfo tileentityInputFurnace) {
      super(new ContainerBlockInfo(inventoryplayer, tileentityInputFurnace));
   ...
   protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
      ...
      super.mc.renderEngine.bindTexture("/mods/provider/ual/guiinfo.png");
