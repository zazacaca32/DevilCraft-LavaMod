...
public class ContainerPressOther extends ContainerBase {

   private TileEntityBlockPressOther tileentity;
   ...
   public ContainerPressOther(InventoryPlayer inventoryplayer, TileEntityBlockPressOther tileentity) {
   ...
   public void updateProgressBar(int par1, int par2) {
      ...
      if(par1 == 2) {
         TileEntityBlockPressOther tileentity = this.tileentity;
