...
public class ContainerPressHammer extends ContainerBase {

   private TileEntityBlockPressHammer tileentity;
   ...
   public ContainerPressHammer(InventoryPlayer inventoryplayer, TileEntityBlockPressHammer tileentity) {
      super(inventoryplayer);
      this.tileentity = tileentity;
      Slot_R r = null;
      r = (Slot_R)Manager.INSTANCE.Get(tileentity.RecipesIndex).get(0);
      SlotInvConsumableIDmeta slot = new SlotInvConsumableIDmeta(r.access, tileentity, 0, 54, 24, r.getFloatIDandDamage());
      ...
      slot = new SlotInvConsumableIDmeta(r.access, tileentity, 2, 54, 46, r.getFloatIDandDamage());
      this.addSlotToContainer(slot);
      this.CalcFullInv(84);
   }
   ...
   public void updateProgressBar(int par1, int par2) {
      ...
      if(par1 == 2) {
         TileEntityBlockPressHammer tileentity = this.tileentity;
