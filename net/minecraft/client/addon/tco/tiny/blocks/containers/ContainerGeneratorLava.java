...
public class ContainerGeneratorLava extends ContainerBase {
   ...
   public ContainerGeneratorLava(InventoryPlayer inventory, TileEntityBlockGeneratorLava tileEntity) {
      super(inventory);
      this.tileentity = tileEntity;
      Slot_R r = null;
      r = (Slot_R)Manager.INSTANCE.Get(this.tileentity.RecipesIndex).get(0);
      SlotInvOutput slot = new SlotInvOutput(this.tileentity, 0, 81, 45);
      this.addSlotToContainer(slot);
      r = (Slot_R)Manager.INSTANCE.Get(this.tileentity.RecipesIndex).get(1);
      SlotInvConsumableIDmeta slot1 = new SlotInvConsumableIDmeta(r.access, this.tileentity, 1, 8, 65, r.getFloatIDandDamage());
