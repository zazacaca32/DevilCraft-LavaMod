...
public class ContainerUpgradeUltima extends ContainerBase {

   private TileEntityBlockUpgradeUltima tileentity;
   ...
   public ContainerUpgradeUltima(InventoryPlayer inventoryplayer, TileEntityBlockUpgradeUltima tileentity) {
   ...
   public void updateProgressBar(int par1, int par2) {
      ...
      if(par1 == 2) {
         TileEntityBlockUpgradeUltima tileentity = this.tileentity;
