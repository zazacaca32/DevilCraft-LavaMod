...
public class ContainerPatternModule extends ContainerBase {

   private TileEntityBlockPatternModule tileentity;
   ...
   public ContainerPatternModule(InventoryPlayer inventoryplayer, TileEntityBlockPatternModule tileentity) {
   ...
   public void updateProgressBar(int par1, int par2) {
      ...
      if(par1 == 2) {
         TileEntityBlockPatternModule tileentity = this.tileentity;
