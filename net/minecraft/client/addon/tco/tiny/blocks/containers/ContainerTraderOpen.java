...
public class ContainerTraderOpen extends MEContainerBase {
   ...
   public ContainerTraderOpen(IInventory inventoryPlayer, TileEntityBlockTrader te) {
      ...
      this.addSlotToContainer(new MESlotFakeUP64(this.tileEntity.cellinvfake, 0, 24, 53, 1));
      this.addSlotToContainer(new MESlotFakeUP64(this.tileEntity.cellinvfake, 1, 24, 17, 0));
      this.addSlotToContainer(new MESlotTrader(this.tileEntity.cellinvfake, 2, 80, 17, 1));
