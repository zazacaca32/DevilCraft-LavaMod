...
public class ContainerHelm extends ContainerBase {

   private TileEntityBlockHelm tileentity;
   ...
   public ContainerHelm(InventoryPlayer inventoryplayer, TileEntityBlockHelm tileentity) {
   ...
   public void updateProgressBar(int par1, int par2) {
      ...
      if(par1 == 2) {
         TileEntityBlockHelm tileentity = this.tileentity;
