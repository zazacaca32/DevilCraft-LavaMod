...
public class ContainerClearItem extends ContainerBase {

   private TileEntityBlockClearItem tileentity;
   ...
   public ContainerClearItem(InventoryPlayer inventoryplayer, TileEntityBlockClearItem tileentityInputFurnace) {
      super(inventoryplayer);
      this.tileentity = tileentityInputFurnace;
      Slot_R r = null;
      r = (Slot_R)Manager.INSTANCE.Get(tileentityInputFurnace.RecipesIndex).get(0);
      SlotInvConsumableIDmeta slot = new SlotInvConsumableIDmeta(r.access, tileentityInputFurnace, 0, 53, 35, r.getFloatIDandDamage());
      this.addSlotToContainer(slot);
      r = (Slot_R)Manager.INSTANCE.Get(tileentityInputFurnace.RecipesIndex).get(1);
      SlotInvConsumableID slot1 = new SlotInvConsumableID(r.access, tileentityInputFurnace, 1, 111, 35, r.getFloatIDandDamage());
   ...
   public void updateProgressBar(int par1, int par2) {
      ...
      if(par1 == 2) {
         TileEntityBlockClearItem tileentity = this.tileentity;
