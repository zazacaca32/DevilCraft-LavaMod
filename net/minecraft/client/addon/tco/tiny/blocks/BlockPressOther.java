...
public class BlockPressOther extends BlockBaseSide {

   public BlockPressOther(int id) {
      super(id);
   }
   ...
   public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
      if(par1World.isRemote) {
         ...
         TileEntityBlockPressOther var10 = (TileEntityBlockPressOther)par1World.getBlockTileEntity(par2, par3, par4);
         if(var10 != null) {
   ...
   public TileEntity createTileEntity(World world, int metadata) {
      return new TileEntityBlockPressOther();
   }
