...
public class BlockPresentPirat extends BlockContainer {

   public BlockPresentPirat(int id) {
   ...
   public void onBlockPlacedBy(World world, int i, int j, int k, EntityLiving entityliving, ItemStack itemStack) {
      ...
      if(te != null && te instanceof TileEntityBlockPresentPirat) {
         ((TileEntityBlockPresentPirat)te).setFacing(facing);
   ...
   public TileEntity createNewTileEntity(World world) {
      return new TileEntityBlockPresentPirat();
   }
