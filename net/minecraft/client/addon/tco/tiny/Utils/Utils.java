...
public final class Utils {
   ...
   public static Field getPrivateField(Class fromClass, String ... names) throws NoSuchFieldException {
      ...
      while(var9 < i) {
         ...
         try {
            field = fromClass.getDeclaredField(var91);
      ...
      if(names.length == 1) {
         ...
         throw new NoSuchFieldException("Could not find a field with any of the following names: " + var91 + "]");
      }
   }
   ...
   public static boolean findDarkEnergyNode(World world, int x, int y, int z) {
      ...
      int[] var5 = DarckNodesID;
      int var6 = var5.length;

      for(int var7 = 0; var7 < var6; ++var7) {
         int id_node = var5[var7];
         if(id == id_node) {
            return true;
         }
      }
   ...
   public static String getItemDisplayName(Object o) {
      if(o == null) {
         ...
         String errA;
         if(o instanceof LAItemStack) {
            errA = ((LAItemStack)o).getDisplayName();
            ...
            try {
               ...
               try {
                  String var5 = itemStack.getItemName();
   ...
   public static boolean NBTEqualityTest(NBTBase A, NBTBase B) {
      ...
      if(id != B.getId()) {
         ...
         case 9:
            NBTTagList var10 = (NBTTagList)A;
            NBTTagList var11 = (NBTTagList)B;
            if(var10.tagCount() != var11.tagCount()) {
               return false;
            } else {
               for(int var12 = 0; var12 < var10.tagCount(); ++var12) {
                  NBTBase var13 = var10.tagAt(var12);
                  NBTBase var14 = var11.tagAt(var12);
                  if(var14 == null) {
                     return false;
                  }
         ...
         case 10:
            ...
            Collection x = lA.getTags();
            Collection tag = lB.getTags();
            if(x.size() != tag.size()) {
               return false;
            } else {
               Iterator aTag = x.iterator();
               ...
               do {
                  ...
                  tag1 = (NBTBase)aTag.next();
                  aTag1 = lB.getTag(tag1.getName());
                  if(aTag1 == null) {
                     return false;
                  }
      ...
      for(int x_ = x - 1; x_ < x + 1; ++x_) {
         for(int y_ = y - 1; y_ < y + 1; ++y_) {
            for(int z_ = z - 1; z_ < z + 1; ++z_) {
               int id = world.getBlockId(x, y, z);
               int[] var10 = DarckNodesID;
               int var11 = var10.length;

               for(int var12 = 0; var12 < var11; ++var12) {
                  int id_node = var10[var12];
                  if(id == id_node) {
                     result[i++] = true;
                  }
               }
   ...
   public static boolean findDarkEnergyNodeFromID(int blockID) {
      int[] var1 = DarckNodesID;
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         int id_node = var1[var3];
         if(blockID == id_node) {
            return true;
         }
      }
   ...
   public static boolean sameStackStags(ItemStack a, ItemStack b) {
      if(a == null && b == null) {
         ...
         if(a == b) {
            ...
            NBTTagCompound tb;
            return ta == (tb = b.getTagCompound())?true:((ta != null || tb != null) && (ta == null || !ta.hasNoTags() || tb != null) && (tb == null || !tb.hasNoTags() || ta != null) && (ta == null || !ta.hasNoTags() || tb == null || !tb.hasNoTags())?((ta != null || tb == null) && (ta == null || tb != null)?NBTEqualityTest(ta, tb):false):true);
         }
      } else {
         return false;
      }
   ...
   public static void sumItemToList(List out, LAItemStack sub) {
      if(sub != null) {
         Iterator var2 = out.iterator();

         while(var2.hasNext()) {
            LAItemStack g = (LAItemStack)var2.next();
            if(g.equals(sub)) {
