...
import net.minecraft.client.addon.tco.tiny.fx.WRMat4;
...
public class WRVector3 {
   ...
   public static WRVector3 xCrossProduct(WRVector3 vec) {
      return new WRVector3(0.0D, (double)vec.z, (double)(-vec.y));
   }

   public static WRVector3 zCrossProduct(WRVector3 vec) {
      return new WRVector3((double)(-vec.y), (double)vec.x, 0.0D);
   }
