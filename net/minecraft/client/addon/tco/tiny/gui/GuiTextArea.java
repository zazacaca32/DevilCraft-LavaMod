...
public class GuiTextArea extends Gui {
   ...
   public void drawTextBox() {
      ...
      for(cursorPositionX = 0; cursorPositionX < this.lineCount; ++cursorPositionX) {
         this.fontRenderer.drawStringWithShadow(this.text[cursorPositionX], textLeft, textTop + (this.fontRenderer.FONT_HEIGHT + 1) * cursorPositionX, 14737632);
      }
   ...
   private void drawCursorVertical(int left, int top, int right, int bottom) {
      ...
      Tessellator var61 = Tessellator.instance;
      GL11.glColor4f(0.0F, 0.0F, 255.0F, 255.0F);
      GL11.glDisable(3553);
      GL11.glEnable(3058);
      GL11.glLogicOp(5387);
      var61.startDrawingQuads();
      var61.addVertex((double)left, (double)bottom, 0.0D);
      var61.addVertex((double)right, (double)bottom, 0.0D);
      var61.addVertex((double)right, (double)top, 0.0D);
      var61.addVertex((double)left, (double)top, 0.0D);
      var61.draw();
      GL11.glDisable(3058);
      GL11.glEnable(3553);
   }
