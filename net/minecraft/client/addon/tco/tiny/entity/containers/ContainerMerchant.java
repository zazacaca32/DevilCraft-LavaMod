...
import net.minecraft.client.addon.tco.tiny.entity.inventory.SlotMerchantResult;
...
public class ContainerMerchant extends Container {
   ...
   public ContainerMerchant(InventoryPlayer par1InventoryPlayer, IMerchant par2IMerchant, World par3World) {
      ...
      this.addSlotToContainer(new Slot(this.merchantInventory, 0, 34, 146));
      this.addSlotToContainer(new Slot(this.merchantInventory, 1, 53, 146));
      this.addSlotToContainer(new SlotMerchantResult(this, par1InventoryPlayer.player, par2IMerchant, this.merchantInventory, 2, 107, 146));
