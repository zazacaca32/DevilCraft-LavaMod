...
public class EntityManTrader extends EntityCreature implements INpc, IMerchant {
   ...
   public EntityManTrader(World par1World) {
      super(par1World);
   ...
   public boolean interact(EntityPlayer par1EntityPlayer) {
      ...
      if(!flag && this.isEntityAlive() && !this.isTrading() && !this.isChild()) {
         if(!super.worldObj.isRemote) {
            ...
            par1EntityPlayer.openGui(Tiny.instance, 10028, par1EntityPlayer.worldObj, super.entityId, 0, 0);
         }
