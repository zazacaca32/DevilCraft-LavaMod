...
public class SlotMerchantResult extends Slot {
   ...
   public SlotMerchantResult(ContainerMerchant containerMerchant, EntityPlayer par1EntityPlayer, IMerchant par2IMerchant, InventoryMerchant par3InventoryMerchant, int par4, int par5, int par6) {
