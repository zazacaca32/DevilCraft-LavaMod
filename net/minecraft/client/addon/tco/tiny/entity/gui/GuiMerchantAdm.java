...
public class GuiMerchantAdm extends GuiContainer {
   ...
   public GuiMerchantAdm(InventoryPlayer par1, IMerchant par2, World par3World, String par4) {
      super(new ContainerMerchantAdm(par1, par2, par3World));
         ...
         if(!flag2) {
            ...
            for(int k = 0; k < 6; ++k) {
               for(int l = 0; l < 9; ++l) {
                  int k2 = 8 + l * 18;
                  int i2 = 14 + k * 18;
                  if(this.isPointInRegion(k2, i2, 16, 16, par1, par2)) {
                     break label40;
                  }
   ...
   public void drawScreen(int par1, int par2, float par3) {
      ...
      if(merchantrecipelist != null && !merchantrecipelist.isEmpty()) {
         ...
         if(merchantrecipe.ismaxTradeUses()) {
            super.fontRenderer.drawString("100из100", k + 10, l + 100, 4210752);
         } else {
            super.fontRenderer.drawString("" + merchantrecipe.getToolUses() + "из100", k + 125, l + 130, 4210752);
         }
         ...
         if(var201.getItemStack() == null) {
            ...
            } else if(this.isPointInRegion(107, 124, 16, 16, par1, par2)) {
