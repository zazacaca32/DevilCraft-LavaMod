...
public class BlockElka extends BlockContainer
{
    @SideOnly(Side.CLIENT)
    private Icon icon;

    public BlockElka(int id)
    {
    ...
    {
        super.blockIcon = Block.wood.getIcon(1, 0);
    }

    public TileEntity createNewTileEntity(World world)
    {
        return new ElkaTileBlock();
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityplayer, int side, float a, float b, float c)
    {
        ...
        {
            ElkaTileBlock var10 = (ElkaTileBlock)world.getBlockTileEntity(x, y, z);

            if (var10 != null)
            {
                entityplayer.openGui(ModBlocks.instance, 501, world, x, y, z);
            }
