...
public class BlockFlamBeau extends BlockContainer
{
    private ForgeDirection side;
    @SideOnly(Side.CLIENT)
    private Icon icon;

    public BlockFlamBeau(int id)
    {
    ...
    public void updateLadderBounds(int par1)
    {
        if (par1 == 2)
        {
            this.setBlockBounds(0.7F, 0.0F, 0.0F, 0.3F, 1.0F, 1.0F);
        }
        ...
        if (par1 == 4)
        {
            this.setBlockBounds(0.0F, 0.0F, 0.7F, 1.0F, 1.0F, 0.3F);
        }
