...
public class HeroSpearEntity extends EntityArrow
{
    private int tick = 0;

    public HeroSpearEntity(World par1World)
    {
        super(par1World);
    ...
    public HeroSpearEntity(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        super.renderDistanceWeight = 10.0D;
