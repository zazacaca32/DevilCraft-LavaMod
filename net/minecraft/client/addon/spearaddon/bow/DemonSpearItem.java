...
public class DemonSpearItem extends BaseSpearItem
{
    public DemonSpearItem(int par1)
    {
        super(par1);
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4)
    {
        ...
        par2List.add("§dНаносит урон " + super.Demon(par1ItemStack) + "!");
        ...
        if (par1ItemStack.stackTagCompound != null && par1ItemStack.stackTagCompound.hasKey("lswordstartr") && par1ItemStack.stackTagCompound.getString("lswordstartr").equals(par3EntityPlayer.getEntityName()))
        {
            ...
            if (!event.isCanceled())
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    DemonSpearEntity entityarrow = new DemonSpearEntity(par2World, par3EntityPlayer, f * 2.0F);
                    int arrowdam = super.Demon(par1ItemStack);
