...
public class BagRender implements IItemRenderer
{
    protected ModelBagPirat chestprizModel1 = new ModelBagPirat();
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        switch (type.ordinal())
        {
            case 1:
                ...
                Minecraft.getMinecraft().renderEngine.bindTexture("/mods/OpenClade.png");
                this.chestprizModel1.render((Entity)data[1], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
                GL11.glPopMatrix();
