...
public class HeroSpearEntityRender extends Render
{
    public void EntityHeroSpear(HeroSpearEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        ((HeroSpearModel)ClientProxy.Models[3]).render();
        GL11.glPopMatrix();
    }

    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        this.EntityHeroSpear((HeroSpearEntity)par1Entity, par2, par4, par6, par8, par9);
    }
}
