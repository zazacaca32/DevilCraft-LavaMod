...
public class HeroSpearItem extends BaseSpearItem
{
    public HeroSpearItem(int par1)
    {
        super(par1);
        super.maxStackSize = 1;
        this.setMaxDamage(1500);
        this.setCreativeTab(LavaChestPlate.tabArmor);
        this.setUnlocalizedName("HeroSpear");
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4)
    {
        ...
        par2List.add("§dНаносит урон " + super.Hero(par1ItemStack) + "!");
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (!event.isCanceled())
        {
            ...
            if ((double)f >= 0.1D)
            {
                ...
                HeroSpearEntity entityarrow = new HeroSpearEntity(par2World, par3EntityPlayer, f * 2.0F);
                int arrowdam = super.Hero(par1ItemStack);
