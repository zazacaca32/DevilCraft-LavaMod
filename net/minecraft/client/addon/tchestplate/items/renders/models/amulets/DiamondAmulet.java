...
public class DiamondAmulet extends BaseItemModel
{
    BodyPart Shape1;
    BodyPart Shape2;
    BodyPart Shape3;
    ...
    public DiamondAmulet(String tex)
    {
        super(BaseItemModel.ModelType.BODY);
        super.textureWidth = 32;
        super.textureHeight = 32;
        (this.Shape1 = new BodyPart(this, 4, 0)).addBox(2.0F, 2.0F, -3.5F, 3, 3, 1);
        this.Shape1.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape1.setTextureSize(32, 32);
        this.Shape1.mirror = true;
        this.setRotation(this.Shape1, 0.0F, 0.0F, ((float)Math.PI / 4F));
        (this.Shape2 = new BodyPart(this, 0, 0)).addBox(2.5F, -1.0F, -2.0F, 1, 5, 1);
        this.Shape2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape2.setTextureSize(32, 32);
        this.Shape2.mirror = true;
        this.setRotation(this.Shape2, -0.4014257F, 0.0F, ((float)Math.PI / 5F));
        (this.Shape3 = new BodyPart(this, 0, 0)).addBox(-3.5F, -0.9F, -2.0F, 1, 5, 1);
        this.Shape3.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape3.setTextureSize(32, 32);
        this.Shape3.mirror = true;
        this.setRotation(this.Shape3, -0.418879F, 0.0F, -0.6108652F);
        (this.Shape4 = new BodyPart(this, 12, 0)).addBox(-1.0F, 4.0F, -3.7F, 2, 2, 1);
        this.Shape4.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape4.setTextureSize(32, 32);
        this.Shape4.mirror = true;
        this.setRotation(this.Shape4, 0.0F, 0.0F, 0.0F);
        (this.Shape5 = new BodyPart(this, 12, 0)).addBox(2.5F, 2.5F, -3.9F, 2, 2, 1);
        this.Shape5.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape5.setTextureSize(32, 32);
        this.Shape5.mirror = true;
        this.setRotation(this.Shape5, 0.0F, 0.0F, ((float)Math.PI / 4F));
        (this.Shape6 = new BodyPart(this, 12, 3)).addBox(-0.5F, 4.0F, -4.1F, 1, 2, 1);
        this.Shape6.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape6.setTextureSize(32, 32);
        this.Shape6.mirror = true;
        this.setRotation(this.Shape6, 0.0F, 0.0F, 0.0F);
        (this.Shape7 = new BodyPart(this, 12, 4)).addBox(-1.0F, 4.5F, -4.0F, 2, 1, 1);
        this.Shape7.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape7.setTextureSize(32, 32);
        this.Shape7.mirror = true;
        this.setRotation(this.Shape7, 0.0F, 0.0F, 0.0F);
        (this.Shape8 = new BodyPart(this, 4, 4)).addBox(-0.5F, 4.5F, -4.2F, 1, 1, 1);
