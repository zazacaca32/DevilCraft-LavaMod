...
public class minonyPet extends BasePet
{
    ...
    private static final String tex = "/mods/LavaChestPlate/textures/items/pet/minony.png";

    public minonyPet(boolean b)
    {
        ...
        this.setTexture("/mods/LavaChestPlate/textures/items/pet/minony.png");
    }
