...
public class GuiItemPets extends GuiContainer
{
    EntityPlayer player;
    ArmorExtInventory inv;
    float time = 180.0F;

    public GuiItemPets(InventoryPlayer iinventory, World world, int x, int y, int z, ExtendedPlayer extendedPlayer)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j)
    {
        ...
        super.mc.renderEngine.bindTexture("/mods/LavaChestPlate/textures/gui/guiitemspets.png");
        ...
        if (s != null && s.getItem() instanceof ItemPets)
        {
            ...
            this.drawString(super.fontRenderer, h + "%", left + 100, top + 45, 8947882);
        }
    }
