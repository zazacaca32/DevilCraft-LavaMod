...
public class Uham extends BaseHammerWeapon
{
    public Uham(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        super.itemIcon = par1IconRegister.registerIcon("provider:uham");
    }
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4)
    {
        ...
        par2List.add("§8 Урон от которого в 2500!");
