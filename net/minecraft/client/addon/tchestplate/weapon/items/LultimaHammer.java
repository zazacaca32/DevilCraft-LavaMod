...
public class LultimaHammer extends BaseHammerWeapon
{
    public LultimaHammer(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        super.itemIcon = par1IconRegister.registerIcon("LavaChestPlate:lultimahammer");
    }
    ...
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity)
    {
        if (stack.stackTagCompound != null && stack.stackTagCompound.hasKey("lHammerstart") && stack.stackTagCompound.getString("lHammerstart").equals(player.getEntityName()))
        {
            ...
            else
            {
                ...
                if (entity.attackEntityFrom(DamageSource.causePlayerDamage(player), 4000))
                {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4)
    {
        ...
        par2List.add("§8 Урон от которого в 4000!");
