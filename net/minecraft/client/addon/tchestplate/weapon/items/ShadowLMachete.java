...
public class ShadowLMachete extends Item
{
    final short damage = 100;

    public ShadowLMachete(int par1)
    {
        super(par1);
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        super.itemIcon = par1IconRegister.registerIcon("LavaChestPlate:ShadowMachete");
    }

    public int getDamageVsEntity(Entity par1Entity, ItemStack itemStack)
    {
        return par1Entity instanceof EntityPlayer ? 200 : 400;
    }
    ...
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity)
    {
        ...
        {
            if (entity.attackEntityFrom(DamageSource.causePlayerDamage(player), 200))
            {
                if (flag)
                {
                    return true;
                ...
                if (!(entity instanceof EntityManTrader) && !(entity instanceof EntityMan))
                {
                    ...
                    for (int var6 = 0; var6 < var5; ++var6)
                    {
                        ...
                        {
                            ((IShadowPlate)armor.getItem()).regenerateLavaEnergy(armor, 20, 1);
                        }
                    }
                }
            }
    ...
    {
        par2List.add("§8 Наносит урон 200!");
        par2List.add("§8 Возвращает 40 урона в виде энергии");
        par2List.add("§8 Деиствует только на Сумеречный сет");
    }
}
