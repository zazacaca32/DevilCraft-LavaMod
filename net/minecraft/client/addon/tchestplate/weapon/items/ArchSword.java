...
public class ArchSword extends Item
{
    double displaydamage;

    public ArchSword(int par1)
    {
        super(par1);
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        super.itemIcon = par1IconRegister.registerIcon("acp:archsword");
        this.displaydamage = 22.0D;
    }
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4)
    {
        if (par1ItemStack.stackTagCompound != null && par1ItemStack.stackTagCompound.hasKey("lawar"))
        {
            ...
            par2List.add("§8 Возвращает 1600 урона в виде энергии");
            par2List.add("§8 Действует только на сет архангела!");
            ...
            if (stack.stackTagCompound != null && stack.stackTagCompound.hasKey("lawar") && stack.stackTagCompound.getString("lawar").equals(player.getEntityName()))
            {
                if (entity.attackEntityFrom(DamageSource.causePlayerDamage(player), 400))
                {
                    ...
                    for (int var101 = 0; var101 < var5; ++var101)
                    {
                        ...
                        if (armor != null)
                        {
                            ((LavaChestPlateItem)armor.getItem()).charge(armor, 1600);
                        }
                    }
    ...
    {
        return par1Entity instanceof EntityPlayer ? 400 : 400;
    }
