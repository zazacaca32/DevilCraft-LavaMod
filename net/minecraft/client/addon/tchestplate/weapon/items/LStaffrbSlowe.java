...
public class LStaffrbSlowe extends BaseStaffWeapon
{
    ...
    public LStaffrbSlowe(int par1, int max, int cooldown, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        super.itemIcon = par1IconRegister.registerIcon("LavaChestPlate:lstaffrbslowe");
    }
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer p)
    {
        ...
        else
        {
            ...
            if (!world.isRemote)
            {
                world.spawnEntityInWorld(new EntityFrostRed(world, p, this.max * 1000));
            }
