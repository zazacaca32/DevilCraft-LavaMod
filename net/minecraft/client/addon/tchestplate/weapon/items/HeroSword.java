...
public class HeroSword extends Item
{
    public HeroSword(int par1)
    {
        super(par1);
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        super.itemIcon = par1IconRegister.registerIcon("acp:herosword");
    }
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4)
    {
        ...
        {
            par2List.add("§8 Наносит урон 2000!");
    ...
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity)
    {
        ...
        if (!player.worldObj.isRemote)
        {
            ...
            {
                if (entity.attackEntityFrom(DamageSource.causePlayerDamage(player), 2000))
                {
    ...
    {
        return par1Entity instanceof EntityPlayer ? 2000 : 2000;
    }
