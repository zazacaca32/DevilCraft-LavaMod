...
public class LStaffVedma extends BaseStaffWeapon
{
    private long soundDelay;

    public LStaffVedma(int par1, int max, int cooldown, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        super.itemIcon = par1IconRegister.registerIcon("LavaChestPlate:lastaffvedma");
    }
    ...
    public int KD(ItemStack i)
    {
        ...
        return a == 0 ? 12 : (a == 1 ? 12 : (a == 2 ? 12 : (a == 3 ? 13 : (a == 4 ? 13 : (a == 5 ? 12 : (a == 6 ? 12 : (a == 7 ? 11 : (a == 8 ? 11 : (a == 9 ? 10 : (a == 10 ? 10 : (a == 11 ? 9 : (a == 12 ? 9 : (a == 13 ? 8 : (a == 14 ? 8 : (a == 15 ? 7 : (a == 16 ? 7 : 1))))))))))))))));
    }

    public int SHOK(ItemStack i)
    {
        int a = this.getEnchant(i);
        return a == 0 ? 4 : (a == 1 ? 4 : (a == 2 ? 4 : (a == 3 ? 4 : (a == 4 ? 4 : (a == 5 ? 5 : (a == 6 ? 5 : (a == 7 ? 5 : (a == 8 ? 5 : (a == 9 ? 5 : (a == 10 ? 5 : (a == 11 ? 5 : (a == 12 ? 6 : (a == 13 ? 6 : (a == 14 ? 6 : (a == 15 ? 6 : (a == 16 ? 7 : 1))))))))))))))));
    }
