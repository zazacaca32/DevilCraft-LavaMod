...
public class LrbHammer extends BaseHammerWeapon
{
    public LrbHammer(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        super.itemIcon = par1IconRegister.registerIcon("LavaChestPlate:lrbhammer");
    }
    ...
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity)
    {
        if (!player.worldObj.isRemote)
        {
            ...
            if (entity.attackEntityFrom(DamageSource.causePlayerDamage(player), 1800))
            {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4)
    {
        ...
        par2List.add("§8 Урон от которого в 1800!");
