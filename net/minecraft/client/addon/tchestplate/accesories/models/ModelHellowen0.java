...
public class ModelHellowen0 extends ModelBipedAccesories
{
    ...
    final String texture = "/mods/models/accesories/hellowen0.png";

    public ModelHellowen0()
    {
        super.textureWidth = 32;
        super.textureHeight = 32;
        (this.Shape1 = new ModelRenderer(this, 0, 1)).addBox(-4.0F, -7.0F, -5.0F, 8, 6, 1);
        this.Shape1.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape1.setTextureSize(32, 32);
        this.Shape1.mirror = true;
        this.setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
        (this.Shape2 = new ModelRenderer(this, 12, 2)).addBox(-5.0F, -7.0F, -4.0F, 1, 6, 2);
        this.Shape2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape2.setTextureSize(32, 32);
        this.Shape2.mirror = true;
        this.setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
        (this.Shape3 = new ModelRenderer(this, 0, 9)).addBox(2.0F, -10.0F, -7.0F, 4, 4, 3);
        this.Shape3.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape3.setTextureSize(32, 32);
        this.Shape3.mirror = true;
        this.setRotation(this.Shape3, 0.0F, 0.1396263F, 0.1047198F);
        (this.Shape4 = new ModelRenderer(this, 14, 2)).addBox(-4.5F, -7.0F, -4.5F, 1, 6, 1);
        this.Shape4.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape4.setTextureSize(32, 32);
        this.Shape4.mirror = true;
        this.setRotation(this.Shape4, 0.0F, 0.0F, 0.0F);
        (this.Shape5 = new ModelRenderer(this, 0, 9)).addBox(-6.0F, -10.0F, -7.0F, 4, 4, 3);
        this.Shape5.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape5.setTextureSize(32, 32);
        this.Shape5.mirror = true;
        this.setRotation(this.Shape5, 0.0F, 0.0F, 0.0F);
        (this.Shape6 = new ModelRenderer(this, 1, 6)).addBox(-3.0F, 0.0F, -5.0F, 6, 2, 1);
        this.Shape6.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape6.setTextureSize(32, 32);
        this.Shape6.mirror = true;
        this.setRotation(this.Shape6, 0.0F, 0.0F, 0.0F);
        (this.Shape7 = new ModelRenderer(this, 0, 0)).addBox(-2.0F, 2.0F, -5.0F, 4, 1, 1);
        this.Shape7.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape7.setTextureSize(32, 32);
        this.Shape7.mirror = true;
        this.setRotation(this.Shape7, 0.0F, 0.0F, 0.0F);
        (this.Shape8 = new ModelRenderer(this, 14, 2)).addBox(3.5F, -7.0F, -4.5F, 1, 6, 1);
        this.Shape8.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape8.setTextureSize(32, 32);
        this.Shape8.mirror = true;
        this.setRotation(this.Shape8, 0.0F, 0.0F, 0.0F);
        (this.Shape9 = new ModelRenderer(this, 0, 16)).addBox(-5.0F, -9.0F, -7.3F, 1, 1, 1);
        this.Shape9.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape9.setTextureSize(32, 32);
        this.Shape9.mirror = true;
        this.setRotation(this.Shape9, 0.0F, 0.0F, 0.0F);
        (this.Shape10 = new ModelRenderer(this, 0, 0)).addBox(-4.0F, -2.0F, -5.0F, 1, 2, 1);
        this.Shape10.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape10.setTextureSize(32, 32);
        this.Shape10.mirror = true;
        this.setRotation(this.Shape10, 0.0F, 0.0F, 0.0F);
        (this.Shape11 = new ModelRenderer(this, 0, 0)).addBox(3.0F, -2.0F, -5.0F, 1, 2, 1);
        this.Shape11.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape11.setTextureSize(32, 32);
        this.Shape11.mirror = true;
        this.setRotation(this.Shape11, 0.0F, 0.0F, 0.0F);
        (this.Shape12 = new ModelRenderer(this, 0, 16)).addBox(3.0F, -8.0F, -7.3F, 1, 1, 1);
        this.Shape12.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape12.setTextureSize(32, 32);
        this.Shape12.mirror = true;
        this.setRotation(this.Shape12, 0.0F, 0.1396263F, 0.1047198F);
        (this.Shape13 = new ModelRenderer(this, 12, 2)).addBox(4.0F, -7.0F, -4.0F, 1, 6, 2);
        this.Shape13.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape13.setTextureSize(32, 32);
        this.Shape13.mirror = true;
        this.setRotation(this.Shape13, 0.0F, 0.0F, 0.0F);
        (this.Shape14 = new ModelRenderer(this, 4, 16)).addBox(-2.5F, -1.0F, -5.5F, 1, 2, 1);
        ...
        (this.Shape15 = new ModelRenderer(this, 4, 16)).addBox(-1.5F, -3.0F, -5.5F, 1, 3, 1);
        ...
        (this.Shape16 = new ModelRenderer(this, 4, 16)).addBox(-0.5F, -1.0F, -5.5F, 1, 2, 1);
        ...
        (this.Shape17 = new ModelRenderer(this, 4, 16)).addBox(0.0F, -3.0F, -5.5F, 1, 2, 1);
        this.Shape17.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape17.setTextureSize(32, 32);
        this.Shape17.mirror = true;
        this.setRotation(this.Shape17, -0.0872665F, 0.0F, 0.2792527F);
        (this.Shape18 = new ModelRenderer(this, 4, 16)).addBox(1.5F, -2.0F, -5.5F, 1, 2, 1);
        this.Shape18.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Shape18.setTextureSize(32, 32);
        this.Shape18.mirror = true;
        this.setRotation(this.Shape18, 0.2094395F, 0.0F, 0.0698132F);
    ...
    {
        return "/mods/models/accesories/hellowen0.png";
    }
}
