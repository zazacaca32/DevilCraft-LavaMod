...
public class AccesoriasVolk extends LavaChestPlateHelmet
{
    public AccesoriasVolk(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("LavaChestPlate:Volk");
    }

    @SideOnly(Side.CLIENT)
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer)
    {
        return "/mods/models/accesories/volk.png";
    }
