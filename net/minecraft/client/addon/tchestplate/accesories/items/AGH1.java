...
public class AGH1 extends LavaChestPlateHelmet
{
    public AGH1(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("provider:gh1");
    }

    @SideOnly(Side.CLIENT)
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer)
    {
        return "/mods/provider/ual/acessor/gh1.png";
    }
