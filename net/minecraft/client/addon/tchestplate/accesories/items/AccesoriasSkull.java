...
public class AccesoriasSkull extends LavaChestPlateHelmet
{
    public AccesoriasSkull(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("LavaChestPlate:Skull");
    }

    @SideOnly(Side.CLIENT)
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer)
    {
        return "/mods/models/accesories/skull.png";
    }
