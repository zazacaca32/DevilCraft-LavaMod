...
public class ModelDemonGrud extends ModelBaseLavaArmor {
   ...
   public ModelDemonGrud() {
      ...
      this.Shape7.addBox(0.0F, 0.0F, 0.0F, 4, 2, 5);
      this.Shape7.setRotationPoint(-4.0F, 2.0F, -2.6F);
      this.Shape7.setTextureSize(64, 64);
      this.Shape7.mirror = true;
      this.setRotation(this.Shape7, 0.0F, 0.0174533F, 0.0872665F);
      this.Shape8 = new ModelRenderer(this, 0, 5);
      this.Shape8.addBox(-4.0F, 0.0F, 0.0F, 4, 2, 5);
      this.Shape8.setRotationPoint(4.0F, 2.0F, -2.6F);
      this.Shape8.setTextureSize(64, 64);
      this.Shape8.mirror = true;
      this.setRotation(this.Shape8, 0.0F, -0.0174533F, -0.0872665F);
      this.Shape9 = new ModelRenderer(this, 0, 6);
      this.Shape9.addBox(0.0F, 0.0F, 0.0F, 4, 1, 5);
      this.Shape9.setRotationPoint(-4.0F, 4.5F, -2.5F);
      this.Shape9.setTextureSize(64, 64);
      this.Shape9.mirror = true;
      this.setRotation(this.Shape9, 0.0F, 0.0349066F, 0.122173F);
      this.Shape10 = new ModelRenderer(this, 0, 0);
      this.Shape10.addBox(-4.0F, 0.0F, 0.0F, 4, 1, 5);
      this.Shape10.setRotationPoint(4.0F, 4.5F, -2.5F);
      this.Shape10.setTextureSize(64, 64);
      this.Shape10.mirror = true;
      this.setRotation(this.Shape10, 0.0F, -0.0349066F, -0.122173F);
      this.Shape11 = new ModelRenderer(this, 6, 0);
      this.Shape11.addBox(0.0F, 0.0F, 0.0F, 3, 1, 5);
      this.Shape11.setRotationPoint(-4.0F, 6.0F, -2.5F);
      this.Shape11.setTextureSize(64, 64);
      this.Shape11.mirror = true;
      this.setRotation(this.Shape11, 0.0F, 0.0698132F, 0.1396263F);
      this.Shape12 = new ModelRenderer(this, 0, 6);
      this.Shape12.addBox(-3.0F, 0.0F, 0.0F, 3, 1, 5);
      this.Shape12.setRotationPoint(4.0F, 6.0F, -2.5F);
      this.Shape12.setTextureSize(64, 64);
      this.Shape12.mirror = true;
      this.setRotation(this.Shape12, 0.0F, -0.0698132F, -0.1396263F);
      this.Shape13 = new ModelRenderer(this, 0, 6);
      this.Shape13.addBox(0.0F, 0.0F, 0.0F, 3, 1, 5);
      this.Shape13.setRotationPoint(-4.0F, 7.5F, -2.5F);
      this.Shape13.setTextureSize(64, 64);
      this.Shape13.mirror = true;
      this.setRotation(this.Shape13, 0.0F, 0.122173F, 0.1396263F);
      this.Shape14 = new ModelRenderer(this, 5, 1);
      this.Shape14.addBox(-3.0F, 0.0F, 0.0F, 3, 1, 5);
      this.Shape14.setRotationPoint(4.0F, 7.5F, -2.5F);
      this.Shape14.setTextureSize(64, 64);
      this.Shape14.mirror = true;
      this.setRotation(this.Shape14, 0.0F, -0.122173F, -0.1396263F);
      this.Shape15 = new ModelRenderer(this, 0, 5);
      this.Shape15.addBox(0.0F, 0.0F, 0.0F, 2, 1, 5);
      this.Shape15.setRotationPoint(-4.0F, 9.0F, -2.5F);
      this.Shape15.setTextureSize(64, 64);
      this.Shape15.mirror = true;
      this.setRotation(this.Shape15, 0.0F, 0.1745329F, 0.0872665F);
      this.Shape16 = new ModelRenderer(this, 0, 5);
      this.Shape16.addBox(-2.0F, 0.0F, 0.0F, 2, 1, 5);
      this.Shape16.setRotationPoint(4.0F, 9.0F, -2.5F);
      this.Shape16.setTextureSize(64, 64);
      this.Shape16.mirror = true;
      this.setRotation(this.Shape16, 0.0F, -0.1745329F, -0.0872665F);
      this.Shape17 = new ModelRenderer(this, 0, 0);
      this.Shape17.addBox(0.0F, 0.0F, 0.0F, 8, 2, 1);
      this.Shape17.setRotationPoint(-4.0F, 0.0F, -2.5F);
      ...
      this.Shape19.addBox(0.0F, 0.0F, 0.0F, 2, 12, 1);
      this.Shape19.setRotationPoint(-1.0F, 0.0F, 1.8F);
      this.Shape19.setTextureSize(64, 64);
      this.Shape19.mirror = true;
      this.setRotation(this.Shape19, 0.0F, 0.0F, 0.0F);
      this.Shape20 = new ModelRenderer(this, 0, 0);
      this.Shape20.addBox(0.0F, 0.0F, 0.0F, 1, 12, 1);
      this.Shape20.setRotationPoint(3.0F, 0.0F, 1.8F);
      this.Shape20.setTextureSize(64, 64);
      this.Shape20.mirror = true;
      this.setRotation(this.Shape20, 0.0F, 0.0F, 0.0F);
      this.Shape21 = new ModelRenderer(this, 0, 0);
      this.Shape21.addBox(0.0F, 0.0F, 0.0F, 1, 12, 1);
      this.Shape21.setRotationPoint(-4.0F, 0.0F, 1.8F);
      ...
      this.Shape31.addBox(0.0F, 0.0F, 0.0F, 2, 9, 1);
      this.Shape31.setRotationPoint(-2.0F, -0.5F, -2.7F);
      ...
      this.Shape41.addBox(0.0F, 0.0F, 0.0F, 2, 9, 1);
      this.Shape41.setRotationPoint(0.0F, -0.5F, -2.7F);
      ...
      super.bipedRightArm.addChild(this.Shape31);
      ...
      super.bipedLeftArm.addChild(this.Shape41);
