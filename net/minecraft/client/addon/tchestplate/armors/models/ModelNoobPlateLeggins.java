...
public class ModelNoobPlateLeggins extends ModelBaseLavaArmor {
   ...
   public ModelNoobPlateLeggins() {
      super.textureWidth = 32;
      super.textureHeight = 64;
      super.textureWidth = 32;
      super.textureHeight = 64;
      (this.Shape1 = new ModelRenderer(this, 0, 20)).addBox(-4.5F, 9.0F, -2.5F, 9, 3, 5);
      this.Shape1.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape1.setTextureSize(32, 64);
      this.Shape1.mirror = true;
      this.setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
      (this.Shape2 = new ModelRenderer(this, 13, 53)).addBox(-1.0F, 9.5F, -3.1F, 2, 1, 1);
      this.Shape2.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape2.setTextureSize(32, 64);
      this.Shape2.mirror = true;
      this.setRotation(this.Shape2, 0.0F, 0.0174533F, 0.0F);
      (this.Shape21 = new ModelRenderer(this, 0, 4)).addBox(-2.0F, 0.0F, -2.3F, 4, 8, 1);
      this.Shape21.setTextureSize(32, 64);
      this.Shape21.mirror = true;
      this.setRotation(this.Shape21, 0.0F, 0.0F, 0.0F);
      (this.Shape22 = new ModelRenderer(this, 13, 0)).addBox(-2.3F, 0.0F, -2.0F, 1, 8, 4);
      this.Shape22.setTextureSize(32, 64);
      this.Shape22.mirror = true;
      this.setRotation(this.Shape22, 0.0F, 0.0F, 0.0F);
      (this.Shape23 = new ModelRenderer(this, 9, 32)).addBox(-1.0F, 3.5F, -2.8F, 2, 1, 1);
      ...
      (this.Shape25 = new ModelRenderer(this, 7, 0)).addBox(-2.0F, 0.0F, 1.3F, 4, 8, 1);
