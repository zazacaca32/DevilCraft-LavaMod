...
public class ModelPredatorLavaPlateHelmet extends ModelBaseLavaArmor {
   ...
   public ModelPredatorLavaPlateHelmet() {
      ...
      this.Shape11.addBox(-4.5F, -9.0F, -4.4F, 1, 9, 1);
      this.Shape11.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape11.setTextureSize(64, 32);
      this.Shape11.mirror = true;
      this.setRotation(this.Shape11, 0.0F, 0.0F, -0.0349066F);
      this.Shape12 = new ModelRenderer(this, 2, 17);
      this.Shape12.addBox(-5.0F, -5.7F, -4.9F, 4, 1, 1);
      this.Shape12.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape12.setTextureSize(64, 32);
      this.Shape12.mirror = true;
      this.setRotation(this.Shape12, 0.0F, 0.0F, 0.1570796F);
      this.Shape13 = new ModelRenderer(this, 0, 17);
      this.Shape13.addBox(-2.0F, -6.0F, -5.5F, 4, 1, 1);
      ...
      this.Shape14.addBox(-1.5F, -6.6F, -6.0F, 3, 2, 2);
      ...
      this.Shape15.addBox(4.1F, -9.3F, -3.5F, 1, 9, 8);
      ...
      this.Shape16.addBox(-4.0F, -9.5F, -3.5F, 8, 1, 1);
      ...
      this.Shape17.addBox(-4.0F, -8.5F, -5.0F, 8, 2, 1);
      ...
      this.Shape18.addBox(-5.1F, -9.3F, -3.5F, 1, 9, 8);
      ...
      this.Shape30.addBox(-4.0F, -9.5F, 3.2F, 1, 9, 2);
      ...
      this.Shape31 = new ModelRenderer(this, 8, 0);
      this.Shape31.addBox(-3.0F, -10.0F, 4.7F, 6, 2, 1);
      this.Shape31.setRotationPoint(0.0F, 0.0F, -1.0F);
      this.Shape31.setTextureSize(64, 32);
      this.Shape31.mirror = true;
      this.setRotation(this.Shape31, 0.0523599F, 0.0F, 0.0F);
      this.Shape32 = new ModelRenderer(this, 30, 0);
      this.Shape32.addBox(-3.0F, -9.5F, 4.2F, 6, 6, 1);
      ...
      this.Shape35.addBox(-3.0F, -3.5F, 4.0F, 1, 2, 1);
      ...
      this.Shape36.addBox(1.0F, -7.5F, -6.1F, 4, 1, 2);
      this.Shape36.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape36.setTextureSize(64, 32);
      this.Shape36.mirror = true;
      this.setRotation(this.Shape36, 0.0F, -0.1570796F, -0.1047198F);
      this.Shape37 = new ModelRenderer(this, 0, 0);
      this.Shape37.addBox(4.8F, -8.3F, 0.0F, 2, 1, 3);
      this.Shape37.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape37.setTextureSize(64, 32);
      this.Shape37.mirror = true;
      this.setRotation(this.Shape37, 0.2792527F, 0.4537856F, 0.0F);
      this.Shape38 = new ModelRenderer(this, 0, 0);
      this.Shape38.addBox(3.5F, -9.0F, 0.0F, 3, 1, 7);
      this.Shape38.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape38.setTextureSize(64, 32);
      this.Shape38.mirror = true;
      this.setRotation(this.Shape38, 0.2268928F, 0.0523599F, 0.0F);
      this.Shape39 = new ModelRenderer(this, 0, 0);
      this.Shape39.addBox(-2.0F, -9.0F, 6.0F, 5, 1, 3);
      this.Shape39.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape39.setTextureSize(64, 32);
      this.Shape39.mirror = true;
      this.setRotation(this.Shape39, 0.2094395F, 0.4712389F, 0.0872665F);
      this.Shape40 = new ModelRenderer(this, 0, 0);
      this.Shape40.addBox(-5.0F, -7.5F, -6.1F, 4, 1, 2);
      this.Shape40.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape40.setTextureSize(64, 32);
      this.Shape40.mirror = true;
      this.setRotation(this.Shape40, 0.0F, 0.1570796F, 0.1047198F);
      this.Shape41 = new ModelRenderer(this, 0, 0);
      this.Shape41.addBox(-6.8F, -8.3F, 0.0F, 2, 1, 3);
      this.Shape41.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape41.setTextureSize(64, 32);
      this.Shape41.mirror = true;
      this.setRotation(this.Shape41, 0.2792527F, -0.4537856F, 0.0F);
      this.Shape42 = new ModelRenderer(this, 0, 0);
      this.Shape42.addBox(-6.5F, -9.0F, 0.0F, 3, 1, 7);
      this.Shape42.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape42.setTextureSize(64, 32);
      this.Shape42.mirror = true;
      this.setRotation(this.Shape42, 0.2268928F, -0.0523599F, 0.0F);
      this.Shape43 = new ModelRenderer(this, 0, 0);
      this.Shape43.addBox(-3.0F, -9.0F, 6.0F, 5, 1, 3);
      this.Shape43.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape43.setTextureSize(64, 32);
      this.Shape43.mirror = true;
      this.setRotation(this.Shape43, 0.2094395F, -0.4712389F, -0.0872665F);
      this.Shape44 = new ModelRenderer(this, 54, 11);
      this.Shape44.addBox(7.1F, -5.5F, 3.0F, 1, 8, 1);
      this.Shape44.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape44.setTextureSize(64, 32);
      this.Shape44.mirror = true;
      this.setRotation(this.Shape44, 0.0174533F, 0.0F, -0.0523599F);
      this.Shape45 = new ModelRenderer(this, 54, 8);
      this.Shape45.addBox(9.0F, -5.0F, 2.0F, 1, 4, 1);
      this.Shape45.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape45.setTextureSize(64, 32);
      this.Shape45.mirror = true;
      this.setRotation(this.Shape45, 0.0F, -0.122173F, -0.5235988F);
      this.Shape46 = new ModelRenderer(this, 54, 10);
      this.Shape46.addBox(6.9F, -4.5F, -1.5F, 1, 6, 1);
      this.Shape46.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape46.setTextureSize(64, 32);
      this.Shape46.mirror = true;
      this.setRotation(this.Shape46, -0.2268928F, 0.0F, -0.0698132F);
      this.Shape47 = new ModelRenderer(this, 54, 8);
      this.Shape47.addBox(9.0F, -3.5F, 2.0F, 1, 4, 1);
      this.Shape47.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape47.setTextureSize(64, 32);
      this.Shape47.mirror = true;
      this.setRotation(this.Shape47, 0.0F, 0.0872665F, -0.6632251F);
      this.Shape48 = new ModelRenderer(this, 54, 8);
      this.Shape48.addBox(7.8F, -5.3F, 0.8F, 1, 7, 1);
      this.Shape48.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape48.setTextureSize(64, 32);
      this.Shape48.mirror = true;
      this.setRotation(this.Shape48, -0.1047198F, 0.0F, -0.0698132F);
      this.Shape49 = new ModelRenderer(this, 54, 8);
      this.Shape49.addBox(8.0F, -5.2F, 0.0F, 1, 4, 1);
      this.Shape49.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape49.setTextureSize(64, 32);
      this.Shape49.mirror = true;
      this.setRotation(this.Shape49, 0.0F, 0.0698132F, -0.4537856F);
      this.Shape50 = new ModelRenderer(this, 54, 7);
      this.Shape50.addBox(1.7F, -6.0F, 9.0F, 1, 2, 1);
      this.Shape50.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape50.setTextureSize(64, 32);
      this.Shape50.mirror = true;
      this.setRotation(this.Shape50, 0.5410521F, 0.0F, 0.0F);
      this.Shape50.mirror = false;
      this.Shape51 = new ModelRenderer(this, 54, 5);
      this.Shape51.addBox(3.5F, -7.5F, 6.0F, 1, 12, 1);
      this.Shape51.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape51.setTextureSize(64, 32);
      this.Shape51.mirror = true;
      this.setRotation(this.Shape51, 0.1047198F, 0.0F, 0.0F);
      this.Shape52 = new ModelRenderer(this, 54, 8);
      this.Shape52.addBox(9.0F, -3.0F, 4.5F, 1, 3, 1);
      this.Shape52.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape52.setTextureSize(64, 32);
      this.Shape52.mirror = true;
      this.setRotation(this.Shape52, 0.4014257F, -0.122173F, -0.5585054F);
      this.Shape53 = new ModelRenderer(this, 54, 7);
      this.Shape53.addBox(6.0F, -6.5F, 5.2F, 1, 10, 1);
      this.Shape53.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape53.setTextureSize(64, 32);
      this.Shape53.mirror = true;
      this.setRotation(this.Shape53, 0.0698132F, 0.0F, -0.0349066F);
      this.Shape54 = new ModelRenderer(this, 0, 4);
      this.Shape54.addBox(2.0F, -6.2F, -5.8F, 4, 1, 2);
      this.Shape54.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape54.setTextureSize(64, 32);
      this.Shape54.mirror = true;
      this.setRotation(this.Shape54, 0.0F, -0.1570796F, -0.2792527F);
      this.Shape55 = new ModelRenderer(this, 0, 4);
      this.Shape55.addBox(-6.0F, -6.2F, -5.8F, 4, 1, 2);
      this.Shape55.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape55.setTextureSize(64, 32);
      this.Shape55.mirror = true;
      this.setRotation(this.Shape55, 0.0F, 0.1570796F, 0.2792527F);
      this.Shape56 = new ModelRenderer(this, 54, 4);
      this.Shape56.addBox(5.0F, -5.0F, 8.0F, 1, 2, 1);
      this.Shape56.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape56.setTextureSize(64, 32);
      this.Shape56.mirror = true;
      this.setRotation(this.Shape56, 0.5410521F, 0.0F, -0.1919862F);
      this.Shape57 = new ModelRenderer(this, 54, 9);
      this.Shape57.addBox(1.7F, -7.3F, 7.0F, 1, 12, 1);
      this.Shape57.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape57.setTextureSize(64, 32);
      this.Shape57.mirror = true;
      this.setRotation(this.Shape57, 0.1745329F, 0.0F, 0.0F);
      this.Shape58 = new ModelRenderer(this, 54, 8);
      this.Shape58.addBox(8.0F, -5.0F, -2.0F, 1, 3, 1);
      this.Shape58.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape58.setTextureSize(64, 32);
      this.Shape58.mirror = true;
      this.setRotation(this.Shape58, -0.0698132F, 0.0698132F, -0.4712389F);
      this.Shape59 = new ModelRenderer(this, 54, 7);
      this.Shape59.addBox(6.4F, -4.7F, -4.0F, 1, 8, 1);
      this.Shape59.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape59.setTextureSize(64, 32);
      this.Shape59.mirror = true;
      this.setRotation(this.Shape59, -0.3316126F, 0.0F, -0.0698132F);
      this.Shape60 = new ModelRenderer(this, 54, 8);
      this.Shape60.addBox(-9.0F, -5.0F, -2.0F, 1, 3, 1);
      this.Shape60.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape60.setTextureSize(64, 32);
      this.Shape60.mirror = true;
      this.setRotation(this.Shape60, -0.0698132F, -0.0698132F, 0.4712389F);
      this.Shape61 = new ModelRenderer(this, 54, 7);
      this.Shape61.addBox(-7.4F, -4.7F, -4.0F, 1, 8, 1);
      this.Shape61.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape61.setTextureSize(64, 32);
      this.Shape61.mirror = true;
      this.setRotation(this.Shape61, -0.3316126F, 0.0F, 0.0698132F);
      this.Shape62 = new ModelRenderer(this, 54, 8);
      this.Shape62.addBox(-9.0F, -5.2F, 0.0F, 1, 4, 1);
      this.Shape62.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape62.setTextureSize(64, 32);
      this.Shape62.mirror = true;
      this.setRotation(this.Shape62, 0.0F, -0.0698132F, 0.4537856F);
      this.Shape63 = new ModelRenderer(this, 54, 10);
      this.Shape63.addBox(-7.9F, -4.5F, -1.5F, 1, 6, 1);
      this.Shape63.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape63.setTextureSize(64, 32);
      this.Shape63.mirror = true;
      this.setRotation(this.Shape63, -0.2268928F, 0.0F, 0.0698132F);
      this.Shape64 = new ModelRenderer(this, 54, 8);
      this.Shape64.addBox(-10.0F, -3.5F, 2.0F, 1, 4, 1);
      this.Shape64.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape64.setTextureSize(64, 32);
      this.Shape64.mirror = true;
      this.setRotation(this.Shape64, 0.0F, -0.0872665F, 0.6632251F);
      this.Shape65 = new ModelRenderer(this, 54, 11);
      this.Shape65.addBox(-8.8F, -5.3F, 0.8F, 1, 7, 1);
      this.Shape65.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape65.setTextureSize(64, 32);
      this.Shape65.mirror = true;
      this.setRotation(this.Shape65, -0.1047198F, 0.0F, 0.0698132F);
      this.Shape66 = new ModelRenderer(this, 54, 8);
      this.Shape66.addBox(-10.0F, -5.0F, 2.0F, 1, 4, 1);
      this.Shape66.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape66.setTextureSize(64, 32);
      this.Shape66.mirror = true;
      this.setRotation(this.Shape66, 0.0F, 0.122173F, 0.5235988F);
      this.Shape67 = new ModelRenderer(this, 54, 7);
      this.Shape67.addBox(-8.1F, -5.5F, 3.0F, 1, 8, 1);
      this.Shape67.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape67.setTextureSize(64, 32);
      this.Shape67.mirror = true;
      this.setRotation(this.Shape67, 0.0174533F, 0.0F, 0.0523599F);
      this.Shape68 = new ModelRenderer(this, 54, 7);
      this.Shape68.addBox(-10.0F, -3.0F, 4.5F, 1, 3, 1);
      this.Shape68.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape68.setTextureSize(64, 32);
      this.Shape68.mirror = true;
      this.setRotation(this.Shape68, 0.4014257F, 0.122173F, 0.5585054F);
      this.Shape69 = new ModelRenderer(this, 54, 9);
      this.Shape69.addBox(-7.0F, -6.5F, 5.2F, 1, 10, 1);
      this.Shape69.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape69.setTextureSize(64, 32);
      this.Shape69.mirror = true;
      this.setRotation(this.Shape69, 0.0698132F, 0.0F, 0.0349066F);
      this.Shape69.mirror = false;
      this.Shape70 = new ModelRenderer(this, 54, 4);
      this.Shape70.addBox(-6.0F, -5.0F, 8.0F, 1, 2, 1);
      this.Shape70.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape70.setTextureSize(64, 32);
      this.Shape70.mirror = true;
      this.setRotation(this.Shape70, 0.5410521F, 0.0F, 0.1919862F);
      this.Shape71 = new ModelRenderer(this, 54, 4);
      this.Shape71.addBox(-4.5F, -7.5F, 6.0F, 1, 12, 1);
      this.Shape71.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape71.setTextureSize(64, 32);
      this.Shape71.mirror = true;
      this.setRotation(this.Shape71, 0.1047198F, 0.0F, 0.0F);
      this.Shape72 = new ModelRenderer(this, 54, 7);
      this.Shape72.addBox(-2.7F, -6.0F, 9.0F, 1, 2, 1);
      this.Shape72.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape72.setTextureSize(64, 32);
      this.Shape72.mirror = true;
      this.setRotation(this.Shape72, 0.5410521F, 0.0F, 0.0F);
      this.Shape73 = new ModelRenderer(this, 54, 6);
      this.Shape73.addBox(-2.7F, -7.3F, 7.0F, 1, 12, 1);
      this.Shape73.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape73.setTextureSize(64, 32);
      this.Shape73.mirror = true;
      this.setRotation(this.Shape73, 0.1745329F, 0.0F, 0.0F);
      this.Shape74 = new ModelRenderer(this, 54, 3);
      this.Shape74.addBox(-0.5F, -8.0F, 7.0F, 1, 13, 1);
      this.Shape74.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape74.setTextureSize(64, 32);
      this.Shape74.mirror = true;
      this.setRotation(this.Shape74, 0.2443461F, 0.0F, 0.0F);
      this.Shape75 = new ModelRenderer(this, 54, 9);
      this.Shape75.addBox(5.0F, -7.0F, -2.0F, 1, 7, 1);
      this.Shape75.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape75.setTextureSize(64, 32);
      this.Shape75.mirror = true;
      this.setRotation(this.Shape75, -0.0872665F, 0.0F, -0.0174533F);
      this.Shape76 = new ModelRenderer(this, 54, 7);
      this.Shape76.addBox(6.0F, -6.0F, 0.0F, 1, 6, 1);
      this.Shape76.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape76.setTextureSize(64, 32);
      this.Shape76.mirror = true;
      this.setRotation(this.Shape76, -0.0698132F, 0.0F, -0.1745329F);
      this.Shape77 = new ModelRenderer(this, 54, 7);
      this.Shape77.addBox(6.0F, -7.0F, 2.0F, 1, 8, 1);
      this.Shape77.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape77.setTextureSize(64, 32);
      this.Shape77.mirror = true;
      this.setRotation(this.Shape77, 0.0F, 0.0F, -0.2094395F);
      this.Shape78 = new ModelRenderer(this, 54, 7);
      this.Shape78.addBox(5.0F, -7.0F, 4.0F, 1, 9, 1);
      this.Shape78.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape78.setTextureSize(64, 32);
      this.Shape78.mirror = true;
      this.setRotation(this.Shape78, 0.0523599F, 0.0F, -0.122173F);
      this.Shape79 = new ModelRenderer(this, 54, 7);
      this.Shape79.addBox(3.0F, -8.0F, 4.5F, 1, 11, 1);
      this.Shape79.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape79.setTextureSize(64, 32);
      this.Shape79.mirror = true;
      this.setRotation(this.Shape79, 0.0F, 0.0F, -0.0349066F);
      this.Shape80 = new ModelRenderer(this, 54, 9);
      this.Shape80.addBox(-6.0F, -7.0F, -2.0F, 1, 7, 1);
      this.Shape80.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape80.setTextureSize(64, 32);
      this.Shape80.mirror = true;
      this.setRotation(this.Shape80, -0.0872665F, 0.0F, 0.0174533F);
      this.Shape81 = new ModelRenderer(this, 54, 7);
      this.Shape81.addBox(-7.0F, -6.0F, 0.0F, 1, 6, 1);
      this.Shape81.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape81.setTextureSize(64, 32);
      this.Shape81.mirror = true;
      this.setRotation(this.Shape81, -0.0698132F, 0.0F, 0.1745329F);
      this.Shape82 = new ModelRenderer(this, 54, 7);
      this.Shape82.addBox(-7.0F, -7.0F, 2.0F, 1, 8, 1);
      this.Shape82.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape82.setTextureSize(64, 32);
      this.Shape82.mirror = true;
      this.setRotation(this.Shape82, 0.0F, 0.0F, 0.2094395F);
      this.Shape83 = new ModelRenderer(this, 54, 7);
      this.Shape83.addBox(-6.0F, -7.0F, 4.0F, 1, 9, 1);
      this.Shape83.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape83.setTextureSize(64, 32);
      this.Shape83.mirror = true;
      this.setRotation(this.Shape83, 0.0523599F, 0.0F, 0.122173F);
      this.Shape84 = new ModelRenderer(this, 54, 7);
      this.Shape84.addBox(-4.0F, -8.0F, 4.5F, 1, 11, 1);
      this.Shape84.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape84.setTextureSize(64, 32);
      this.Shape84.mirror = true;
      this.setRotation(this.Shape84, 0.0F, 0.0F, 0.0349066F);
      this.Shape85 = new ModelRenderer(this, 54, 6);
      this.Shape85.addBox(1.0F, -8.0F, 5.5F, 1, 11, 1);
      this.Shape85.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape85.setTextureSize(64, 32);
      this.Shape85.mirror = true;
      this.setRotation(this.Shape85, 0.1570796F, 0.0F, -0.0698132F);
      this.Shape86 = new ModelRenderer(this, 54, 8);
      this.Shape86.addBox(-2.0F, -8.0F, 5.5F, 1, 11, 1);
      this.Shape86.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape86.setTextureSize(64, 32);
      this.Shape86.mirror = true;
      this.setRotation(this.Shape86, 0.1570796F, 0.0F, 0.0698132F);
      this.Shape87 = new ModelRenderer(this, 30, 10);
      this.Shape87.addBox(-4.0F, -5.4F, -4.5F, 8, 2, 1);
      ...
      this.Shape88.addBox(-1.0F, -8.7F, -7.0F, 4, 1, 1);
      this.Shape88.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape88.setTextureSize(64, 32);
      this.Shape88.mirror = true;
      this.setRotation(this.Shape88, -0.6632251F, -0.2443461F, -0.0698132F);
      this.Shape88.mirror = false;
      this.Shape89 = new ModelRenderer(this, 0, 17);
      this.Shape89.addBox(-7.0F, -8.3F, 0.0F, 1, 1, 3);
      this.Shape89.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape89.setTextureSize(64, 32);
      this.Shape89.mirror = false;
      this.setRotation(this.Shape89, 0.2792527F, -0.1443461F, 0.7679449F);
      this.Shape90 = new ModelRenderer(this, 32, 14);
      this.Shape90.addBox(-2.0F, -12.5F, -2.9F, 6, 2, 1);
      this.Shape90.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape90.setTextureSize(64, 32);
      this.Shape90.mirror = true;
      this.setRotation(this.Shape90, 0.0F, -0.9773844F, -0.122173F);
      this.Shape91 = new ModelRenderer(this, 33, 14);
      this.Shape91.addBox(-4.0F, -12.5F, -2.9F, 6, 2, 1);
      this.Shape91.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape91.setTextureSize(64, 32);
      this.Shape91.mirror = true;
      this.setRotation(this.Shape91, 0.0F, 0.9773844F, 0.122173F);
      this.Shape92 = new ModelRenderer(this, 26, 14);
      this.Shape92.addBox(-2.5F, -12.8F, 2.0F, 5, 2, 1);
      this.Shape92.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape92.setTextureSize(64, 32);
      this.Shape92.mirror = true;
      this.setRotation(this.Shape92, 0.0698132F, 0.0F, 0.0F);
      ...
      this.Shape90.isHidden = true;
      this.Shape91.isHidden = true;
      this.Shape92.isHidden = true;
   }
   ...
   protected void ExtRender(EntityPlayer paramEntityPlayer, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, ExtendedPlayer paramExtendedPlayer)
   {
     ...
     {
       this.Shape90.isHidden = false;
       this.Shape91.isHidden = false;
       this.Shape92.isHidden = false;
     }
     else
     {
       this.Shape90.isHidden = true;
