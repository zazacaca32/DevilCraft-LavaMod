...
public class ModelLavaPlateHelmet extends ModelBaseLavaArmor {
   ...
   public ModelLavaPlateHelmet() {
      super.textureWidth = 32;
      super.textureHeight = 64;
      (this.Shape1 = new ModelRenderer(this, 7, 7)).addBox(1.5F, -1.0F, -6.0F, 2, 3, 1);
      this.Shape1.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape1.setTextureSize(32, 64);
      this.Shape1.mirror = true;
      this.setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
      (this.Shape2 = new ModelRenderer(this, 7, 0)).addBox(2.5F, -1.5F, -5.5F, 1, 3, 1);
      this.Shape2.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape2.setTextureSize(32, 64);
      this.Shape2.mirror = true;
      this.setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
      (this.Shape3 = new ModelRenderer(this, 0, 0)).addBox(3.5F, -2.5F, -5.5F, 1, 4, 1);
      this.Shape3.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape3.setTextureSize(32, 64);
      this.Shape3.mirror = true;
      this.setRotation(this.Shape3, 0.0F, 0.0F, 0.0F);
      (this.Shape4 = new ModelRenderer(this, 7, 0)).addBox(4.3F, -3.0F, -4.8F, 1, 4, 1);
      ...
      (this.Shape6 = new ModelRenderer(this, 0, 0)).addBox(4.0F, -1.0F, -4.0F, 1, 1, 4);
      this.Shape6.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape6.setTextureSize(32, 64);
      this.Shape6.mirror = true;
      this.setRotation(this.Shape6, 0.0F, 0.0F, 0.0F);
      (this.Shape7 = new ModelRenderer(this, 8, 11)).addBox(-3.5F, -1.0F, -6.0F, 2, 3, 1);
      this.Shape7.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape7.setTextureSize(32, 64);
      this.Shape7.mirror = true;
      this.setRotation(this.Shape7, 0.0F, 0.0F, 0.0F);
      (this.Shape8 = new ModelRenderer(this, 7, 0)).addBox(-3.5F, -1.5F, -5.5F, 1, 3, 1);
      this.Shape8.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape8.setTextureSize(32, 64);
      this.Shape8.mirror = true;
      this.setRotation(this.Shape8, 0.0F, 0.0F, 0.0F);
      (this.Shape9 = new ModelRenderer(this, 6, 0)).addBox(-4.5F, -2.5F, -5.5F, 1, 4, 1);
      this.Shape9.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.Shape9.setTextureSize(32, 64);
      this.Shape9.mirror = true;
      this.setRotation(this.Shape9, 0.0F, 0.0F, 0.0F);
      (this.Shape10 = new ModelRenderer(this, 1, 1)).addBox(-5.3F, -3.0F, -4.8F, 1, 4, 1);
      ...
      (this.Shape12 = new ModelRenderer(this, 0, 0)).addBox(-5.0F, -1.0F, -4.0F, 1, 1, 4);
      ...
      (this.Shape15 = new ModelRenderer(this, 5, 45)).addBox(-1.0F, -9.2F, -5.5F, 2, 2, 1);
      ...
      (this.Shape18 = new ModelRenderer(this, 6, 41)).addBox(-0.5F, -7.0F, -6.5F, 1, 4, 1);
      ...
      (this.Shape19 = new ModelRenderer(this, 2, 0)).addBox(4.0F, -9.0F, -3.5F, 1, 9, 8);
      ...
      (this.Shape21 = new ModelRenderer(this, 8, 0)).addBox(-4.5F, -9.0F, -4.1F, 1, 3, 1);
      ...
      (this.Shape22 = new ModelRenderer(this, 4, 0)).addBox(-4.0F, -10.0F, -4.0F, 8, 1, 1);
      ...
      (this.Shape23 = new ModelRenderer(this, 7, 0)).addBox(-4.0F, -9.0F, -4.8F, 8, 2, 1);
      ...
      (this.Shape24 = new ModelRenderer(this, 2, 0)).addBox(-5.0F, -9.0F, -3.5F, 1, 9, 8);
      ...
      (this.Shape25 = new ModelRenderer(this, 2, 0)).addBox(4.5F, -8.0F, -3.0F, 1, 8, 7);
      ...
      (this.Shape26 = new ModelRenderer(this, 6, 0)).addBox(5.0F, -7.0F, -2.5F, 1, 6, 6);
      ...
      (this.Shape27 = new ModelRenderer(this, 2, 0)).addBox(-5.5F, -8.0F, -3.0F, 1, 8, 7);
      ...
      (this.Shape28 = new ModelRenderer(this, 2, 0)).addBox(-6.0F, -7.0F, -2.5F, 1, 6, 6);
      ...
      (this.Shape29 = new ModelRenderer(this, 7, 0)).addBox(3.5F, -9.0F, -4.1F, 1, 3, 1);
      ...
      (this.Shape30 = new ModelRenderer(this, 8, 0)).addBox(-4.5F, -10.0F, -3.0F, 9, 1, 2);
      ...
      (this.Shape31 = new ModelRenderer(this, 2, 0)).addBox(-5.0F, -10.0F, -1.0F, 10, 1, 4);
      ...
      (this.Shape32 = new ModelRenderer(this, 6, 2)).addBox(-3.5F, -10.66667F, -3.0F, 7, 1, 2);
      ...
      (this.Shape33 = new ModelRenderer(this, 5, 6)).addBox(-4.0F, -10.66667F, -1.0F, 8, 1, 4);
      ...
      (this.Shape34 = new ModelRenderer(this, 5, 3)).addBox(-3.5F, -10.66667F, 3.0F, 7, 1, 1);
      ...
      (this.Shape35 = new ModelRenderer(this, 3, 0)).addBox(-4.5F, -9.9F, 2.4F, 9, 1, 2);
      ...
      (this.Shape36 = new ModelRenderer(this, 6, 0)).addBox(3.0F, -9.0F, 4.2F, 1, 8, 1);
      ...
      (this.Shape37 = new ModelRenderer(this, 6, 0)).addBox(-4.0F, -9.0F, 4.2F, 1, 8, 1);
      ...
      (this.Shape38 = new ModelRenderer(this, 8, 0)).addBox(-3.0F, -10.0F, 4.7F, 6, 1, 1);
      ...
      (this.Shape39 = new ModelRenderer(this, 8, 0)).addBox(-3.0F, -9.0F, 4.2F, 6, 5, 1);
      ...
      (this.Shape40 = new ModelRenderer(this, 20, 28)).addBox(-2.0F, -8.5F, 5.0F, 4, 1, 1);
      ...
      (this.Shape42 = new ModelRenderer(this, 4, 10)).addBox(-3.0F, -7.5F, 5.0F, 6, 2, 1);
      ...
      (this.Shape43 = new ModelRenderer(this, 20, 28)).addBox(-2.0F, -5.5F, 5.0F, 4, 1, 1);
      ...
      (this.Shape44 = new ModelRenderer(this, 4, 2)).addBox(2.0F, -4.0F, 4.0F, 1, 1, 1);
      ...
      (this.Shape45 = new ModelRenderer(this, 4, 2)).addBox(-3.0F, -4.0F, 4.0F, 1, 1, 1);
      ...
      (this.Shape46 = new ModelRenderer(this, 10, 28)).addBox(5.533333F, -6.7F, 2.0F, 1, 2, 1);
      ...
      (this.Shape47 = new ModelRenderer(this, 9, 30)).addBox(5.4F, -9.0F, -0.1F, 1, 3, 3);
      ...
      (this.Shape48 = new ModelRenderer(this, 10, 29)).addBox(5.533333F, -6.7F, -0.4F, 1, 2, 1);
      ...
      (this.Shape49 = new ModelRenderer(this, 10, 28)).addBox(5.533333F, -4.9F, 0.3F, 1, 1, 2);
      ...
      (this.Shape50 = new ModelRenderer(this, 7, 31)).addBox(6.033333F, -10.73333F, 0.3F, 1, 6, 2);
      ...
      (this.Shape51 = new ModelRenderer(this, 7, 30)).addBox(6.533333F, -12.0F, 0.7F, 1, 7, 2);
      ...
      (this.Shape52 = new ModelRenderer(this, 10, 31)).addBox(7.0F, -11.0F, 1.3F, 1, 5, 1);
      ...
      (this.Shape53 = new ModelRenderer(this, 8, 31)).addBox(6.1F, -13.0F, 0.8F, 1, 3, 2);
      ...
      (this.Shape54 = new ModelRenderer(this, 10, 30)).addBox(5.533333F, -14.0F, 1.3F, 1, 2, 1);
      ...
      (this.Shape55 = new ModelRenderer(this, 3, 30)).addBox(-6.5F, -6.7F, -0.4F, 1, 2, 1);
      ...
      (this.Shape56 = new ModelRenderer(this, 5, 30)).addBox(-6.5F, -4.9F, 0.3F, 1, 1, 2);
      ...
      (this.Shape57 = new ModelRenderer(this, 3, 30)).addBox(-6.5F, -6.7F, 2.0F, 1, 2, 1);
      ...
      (this.Shape58 = new ModelRenderer(this, 1, 31)).addBox(-6.9F, -10.7F, 0.2666667F, 1, 6, 2);
      ...
      (this.Shape59 = new ModelRenderer(this, 3, 31)).addBox(-8.0F, -11.0F, 1.3F, 1, 4, 1);
      ...
      (this.Shape60 = new ModelRenderer(this, 0, 30)).addBox(-7.5F, -12.0F, 0.7F, 1, 6, 2);
      ...
      (this.Shape61 = new ModelRenderer(this, 2, 31)).addBox(-7.0F, -13.0F, 0.8F, 1, 3, 2);
      ...
      (this.Shape62 = new ModelRenderer(this, 4, 28)).addBox(-6.5F, -14.0F, 1.3F, 1, 2, 1);
      ...
      (this.Shape63 = new ModelRenderer(this, 4, 48)).addBox(-1.0F, -11.23333F, -3.0F, 2, 1, 6);
      ...
      (this.Shape64 = new ModelRenderer(this, 8, 52)).addBox(-1.0F, -10.73333F, -4.0F, 2, 1, 1);
      ...
      (this.Shape65 = new ModelRenderer(this, 7, 47)).addBox(-1.0F, -10.0F, -4.8F, 2, 1, 1);
      ...
      (this.Shape67 = new ModelRenderer(this, 4, 28)).addBox(-6.0F, -14.5F, 1.3F, 1, 1, 1);
      ...
      (this.Shape68 = new ModelRenderer(this, 10, 30)).addBox(5.0F, -14.5F, 1.3F, 1, 1, 1);
      ...
      (this.Shape69 = new ModelRenderer(this, 2, 30)).addBox(-6.4F, -9.0F, -0.1F, 1, 3, 3);
