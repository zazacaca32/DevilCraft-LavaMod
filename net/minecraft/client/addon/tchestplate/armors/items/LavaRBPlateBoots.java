...
public class LavaRBPlateBoots extends LavaChestPlateBoots
{
    public LavaRBPlateBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("underqoder:rBoots");
    }
