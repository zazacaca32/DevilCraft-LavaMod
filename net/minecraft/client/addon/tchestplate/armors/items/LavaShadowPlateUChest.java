...
public class LavaShadowPlateUChest extends LavaChestPlateChest implements IShadowPlate
{
    public LavaShadowPlateUChest(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("underqoder:SChestU");
    }
