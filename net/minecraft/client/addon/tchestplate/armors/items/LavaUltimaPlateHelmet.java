...
public class LavaUltimaPlateHelmet extends LavaChestPlateHelmet
{
    public LavaUltimaPlateHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("underqoder:uHelmet");
    }
