...
public class DemonHelmet extends LavaChestPlateHelmet
{
    public DemonHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("qodermelony:demon1");
    }

    @SideOnly(Side.CLIENT)
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer)
    {
        return "/mods/qodermelony/textures/items/demonhead.png";
    }
