...
public class NoobPlateLeggins extends LavaChestPlateLeggins
{
    private long time = 0L;

    public NoobPlateLeggins(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("underqoder:nLeggins");
    }
