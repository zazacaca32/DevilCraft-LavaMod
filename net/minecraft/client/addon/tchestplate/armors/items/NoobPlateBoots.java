...
public class NoobPlateBoots extends LavaChestPlateBoots
{
    private long time = 0L;

    public NoobPlateBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("underqoder:nBoots");
    }
