...
public class LavaShadowPlateUHelmet extends LavaChestPlateHelmet implements IShadowPlate
{
    public LavaShadowPlateUHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("underqoder:SHelmetU");
    }
