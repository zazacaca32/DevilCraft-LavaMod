...
public class AngelBoots extends LavaChestPlateBoots
{
    public AngelBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("provider:AngelBoots");
    }
