...
public class NoobPlateChest extends LavaChestPlateChest
{
    private long time = 0L;

    public NoobPlateChest(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("underqoder:nChest");
    }
