...
public class AngelLeggins extends LavaChestPlateLeggins
{
    public AngelLeggins(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
    ...
    {
        super.itemIcon = par1IconRegister.registerIcon("provider:AngelLeggins");
    }
