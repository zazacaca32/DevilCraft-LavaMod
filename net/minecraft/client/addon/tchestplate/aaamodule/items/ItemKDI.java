...
public class ItemKDI extends Item {

   int id;
   String un;


   public ItemKDI(int par1, int id, String un) {
      super(par1);
      this.id = id;
      this.un = un;
   ...
   public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4) {
      ...
      par2List.add("§8 Модуль: показывает кол-во заряда");
      par2List.add("§8 Модуль: на инструментах и оружии");
      par2List.add("§8 Модуль: шанс вставки 100%");
      par2List.add("§8 Модуль:§4 вставлять только в шлем!");
   }
}
