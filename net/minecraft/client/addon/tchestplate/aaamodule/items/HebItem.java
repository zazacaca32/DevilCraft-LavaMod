...
public class HebItem extends Item {

   int id;
   String un;


   public HebItem(int par1, int id, String un) {
      super(par1);
      this.id = id;
      this.un = un;
   ...
   public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4) {
      par2List.add("§8 Модуль: Добавляет 2000L");
      par2List.add("§8 Модуль: Применяется 1 раз");
      par2List.add("§8 Модуль: Вставляется в ботинки");
      par2List.add("§8 Модуль: Излучает страх ада");
   }
}
