...
public class ItemLGen extends Item {

   int id;
   String un;


   public ItemLGen(int par1, int id, String un) {
      super(par1);
      this.id = id;
      this.un = un;
   ...
   public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4) {
      ...
      par2List.add("§8 Модуль: добавляет по +5L");
      par2List.add("§8 Модуль: регенерации на ед. брони");
