...
public class ItemPanther extends Item {

   int id;
   String un;


   public ItemPanther(int par1, int id, String un) {
      super(par1);
      this.id = id;
      this.un = un;
   ...
   public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par2List, boolean par4) {
      ...
      par2List.add("§8 Модуль: устанавливает облик");
      par2List.add("§8 Модуль: облик: черная пантера.");
