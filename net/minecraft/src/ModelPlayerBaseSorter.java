            ...
            if (this.directInferiorsMap != null)
            {
                for (var1 = 0; var1 < this.list.size() - 1; ++var1)
                {
                    for (var131 = var1 + 1; var131 < this.list.size(); ++var131)
                    {
                        ...
                        if (var9 && var11)
                        {
                            throw new UnsupportedOperationException("Can not sort ModelPlayerBase classes for method \'" + this.methodName + "\'. \'" + var151 + "\' wants to be inferior to \'" + var17 + "\' and \'" + var17 + "\' wants to be inferior to \'" + var151 + "\'");
                        }

                        if (var10 && var12)
                        {
                            throw new UnsupportedOperationException("Can not sort ModelPlayerBase classes for method \'" + this.methodName + "\'. \'" + var151 + "\' wants to be superior to \'" + var17 + "\' and \'" + var17 + "\' wants to be superior to \'" + var151 + "\'");
                        }

                        if (var9 && var10)
                        {
                            throw new UnsupportedOperationException("Can not sort ModelPlayerBase classes for method \'" + this.methodName + "\'. \'" + var151 + "\' wants to be superior and inferior to \'" + var17 + "\'");
                        }

                        if (var11 && var12)
                        {
                            throw new UnsupportedOperationException("Can not sort ModelPlayerBase classes for method \'" + this.methodName + "\'. \'" + var17 + "\' wants to be superior and inferior to \'" + var151 + "\'");
                        }
                    }
                }
